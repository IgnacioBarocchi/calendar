...
const StorageService_ts_1 = __importDefault(require("../../StorageService/StorageService.ts"));
class Modal {
    storage;
    ...
    showEventDetails(calendarEventElement, position) {
        ...
        this.eventDetailsModalElement.querySelector("#event-details-title").textContent = calendarEvent.title;
        this.eventDetailsModalElement.querySelector("#event-details-description").textContent = calendarEvent.description;
        // !todo constructor!!!!
        this.eventDetailsModalElement
...
exports.Modal = Modal;
const st = new StorageService_ts_1.default();
exports.default = new Modal(st);
